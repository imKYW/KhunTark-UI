...
function extCastbar(self)
    ...
    elseif self.unit == 'target' then
        ...
        castbarName:SetFont(cfg.font, 18, cfg.fontflag)
        castbarName:SetJustifyH('LEFT')
        castbarName:SetPoint('LEFT', castbar, 'LEFT', 2, 0)
        castbarTime:SetFont(cfg.bfont, 18, cfg.fontflag)
        castbarTime:SetJustifyH('RIGHT')
        castbarTime:SetPoint('RIGHT', castbar, 'RIGHT', -1, 0)
    ...
    elseif self.unit == 'nameplate' then
        castbar:SetSize(86, 8)
        castbar:SetPoint('TOPRIGHT', self, 'BOTTOMRIGHT', 0, -4)
        castbarIcon:SetSize(20, 20)
        castbarIcon:SetPoint('TOPRIGHT', castbar, 'TOPLEFT', -4, 0)
        castbarName:SetFont(cfg.font, 9, cfg.fontflag)
        castbarName:SetJustifyH('LEFT')
        castbarName:SetPoint('TOPLEFT', castbar, 'BOTTOMLEFT', 0, -3)
        castbarTime:SetFont(cfg.bfont, 8, cfg.fontflag)
        castbarTime:SetJustifyH('RIGHT')
        castbarTime:SetPoint('RIGHT', castbar, 'RIGHT', 0, 0)
        castbarShield:SetSize(44, 44)
        castbarShield:SetPoint("CENTER", castbarIcon, "CENTER", 0, 1)
    end
