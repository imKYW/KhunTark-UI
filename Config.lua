...
cfg.subUF = {
	party = {
		width = 80,
		height = 25,
		position = { sa = 'BOTTOMRIGHT', a = UIParent, pa = 'CENTER', x = -190, y = -25 },
	},
	raid = {
		width = 44,
		height = 44,
	...
	boss = { -- arena
		width = 80,
		height = 25,
		position = { sa = 'BOTTOMLEFT', a = UIParent, pa = 'CENTER', x = 250, y = -25 },
	},
	tank = {
		width = 95,
		height = 34,
...
cfg.castbar = {
	...
	focus = {
		width = 140,
		height = 13,
		position = { sa = 'CENTER', a = UIParent, pa = 'CENTER', x = 0, y = 75 },
	},
	arena = {
		width = 100,
		height = 14,
